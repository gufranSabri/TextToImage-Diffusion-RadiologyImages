...
def filtered_caption(caption):
    ...
    prompt += "Above is a medical caption. Do the following: \n"
    # prompt += "If the caption has the body type and image type and view of the image, rewrite the caption as follows: <Image type> image of the <Body part> from <View>. Don't use abbreviations; example, instead of CT, say computed tomography..\n"
