...
def train(args):
    ...
    for epoch in range(int(args.epochs)):
      ...
      if epoch % 10 == 0 or int(args.epochs) - epoch < 5:
      ...
      if int(args.epochs) - epoch < 5 or epoch == int(args.epochs)//2:
        torch.save(ema_model.state_dict(), os.path.join(model_path, f"ema_model_{epoch+1}.pth"))
